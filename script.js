...
function addHtml() {
  document.getElementsByTagName("body")[0].innerHTML = `<div id="heading">
        <div id="head">
    ...
    <div class="container">
        ...
        <div class="indiv">
            ...
            <div class="text_input" contenteditable="true" style="width: 20%;"></div>
            Roll No. -
            <div class="text_input" contenteditable="true" style="margin-left: 1px;width: 11%;"></div>
            Department -
        ...
        <div class="indiv">
            2. Son of -
            <div class="text_input" contenteditable="true" style="width: 29%;"></div>
            Semester -
            <div class="text_input" contenteditable="true" style="width: 11%;"></div>
        </div>
        ...
        <div class="indiv">
            ...
            Email -
            <div class="text_input" contenteditable="true" style="margin-left: 17px;min-width: 25.5%;max-width: 40%;"></div>
        </div>
        ...
        <div class="indiv">
            ...
            Month and Year -
            <div class="text_input_underline" contenteditable="true"
                style="width: 26%;margin-left: 5px;margin-right: 5px;text-align: center;"></div>
        </div>
        ...
        <div class="indiv">
            ...
            <div class="text_input" contenteditable="true"
                style="min-width: 40%;max-width: 40%;margin-right: 10px;margin-top: 5px">
            </div>
            Mobile No -
            <div class="text_input" contenteditable="true" style="width: 28.8%;"></div>
        </div>

        <div class="indiv">
            6. Name of Bank -
            <div class="text_input" contenteditable="true" style="width: 19%;margin-right: 1%"></div>
            Account No. -
            <div class="text_input" contenteditable="true" style="width: 20%;margin-right: 1%;">
            </div>
            IFSC Code -
            <div class="text_input" contenteditable="true" style="width: 19.5%;">
            </div>
        </div>

        <div class=" indiv"
            style="text-align: right;height: 40px;font-weight: bold;display: flex;align-items: flex-end;flex-direction: column; justify-content: flex-end;padding: 0px 2% 0px 0px;">
        ...
        <div class="indiv" style="margin-top: -13px;margin-bottom: 0;">
            ...
            <div id="grid-container" style="display: grid;column-gap:0;row-gap: 0;margin-top: 4%;margin-bottom: 0;">
                <div class=" indiv" style="font-weight: bold;display: inline;grid-column: 1/2;text-align: left;">
